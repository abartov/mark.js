  ...
  var RegExpCreator = /*#__PURE__*/function () {
    ...
    return _createClass(RegExpCreator, [{
      ...
      value: function createDiacriticsRegExp(str) {
        ...
        str = str.replace(/([\u05D0-\u05EA])/g, "$1[\u0591-\u05C7]*");
        str = str.replace(/([\u0600-\u064A\u0660-\u066D\u066E-\u06D3\u06D5\u06EE-\u06FF])/g, "$1[\u064B-\u065F\u0670\u06D6-\u06ED]*");
        return str;
      }
    }, {
    ...
    return _createClass(Mark, [{
      ...
      value: function markRanges(rawRanges, opt) {
        ...
        if (ranges && ranges.length) {
          ...
          this.wrapRangeFromIndex(ranges, function (node, range, match, counter) {
            return _this0.opt.filter(node, range, match, counter);
          }, function (element, range) {
            totalMatches++;
            _this0.opt.each(element, range);
          }, function () {
            _this0.opt.done(totalMatches);
          });
        } else {
          this.opt.done(totalMatches);
        }
      ...
      value: function unmark(opt) {
        ...
        this.iterator.forEachNode(NodeFilter.SHOW_ELEMENT, function (node) {
          _this1.unwrapMatches(node);
        }, function (node) {
          var matchesSel = DOMIterator.matches(node, sel),
            matchesExclude = _this1.matchesExclude(node);
